...
let PostListFollowing = () => {
    ...
    const getUser = async () => {
        let { data } = await axios.get("https://dev-room-backend.onrender.com/api/users/me", {
            headers: {
    ...
    const getFollowingPosts = async () => {
        let { data: postsData } = await axios.get("https://dev-room-backend.onrender.com/api/posts/", {
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${localStorage.getItem("devroom")}`,
            },
    ...
    let submitCreatePost = async (e) => {
        ...
        if (localPost.text.trim() !== "") {
            const { data } = await axios.post("https://dev-room-backend.onrender.com/api/posts/", localPost, {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("devroom")}`,
                },
    ...
    let clickDeletePost = async (postId) => {
        const { data } = await axios.delete(`https://dev-room-backend.onrender.com/api/posts/${postId}`, {
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${localStorage.getItem("devroom")}`,
            },
    ...
    let clickLikePost = async (postId) => {
        const { data } = await axios.put(`https://dev-room-backend.onrender.com/api/posts/like/${postId}`, {}, {
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${localStorage.getItem("devroom")}`,
            }
